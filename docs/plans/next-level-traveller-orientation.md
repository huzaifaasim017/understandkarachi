---
title: Next-level traveller orientation implementation plan
status: complete
owner: project maintainers
started: 2026-08-13
last-updated: 2026-08-14
last-reviewed: 2026-08-14
review-cycle: archived; update only if this workstream reopens
workstream: next-level-traveller-orientation
---

# Next-level traveller orientation implementation plan

> Archived from `docs/plans/active.md` on 2026-08-14 when the
> `route-internalization-and-civic-diagnostics-v1` workstream became active.
> Content unchanged from the version that shipped with
> [release v3](../releases/2026-08-14-v3.md).
...
in the [release record](../releases/2026-08-14-v3.md). Follow-up work continues
under [route-internalization-and-civic-diagnostics-v1](active.md).
